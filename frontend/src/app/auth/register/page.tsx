...
const ROLES = [
  ...
  { value: 'carpenter', label: '🪑 Carpenter / Furniture Maker', desc: 'Sell furniture, doors & finished woodwork' },
...
function RegisterContent() {
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-stone-200 p-10 text-center max-w-md w-full">
          ...
          <p className="text-stone-500 mb-2 text-sm">
            {form.role === 'buyer'
              ...
              : 'Your account has been created! Upload your licenses in the dashboard for admin review.'}
          </p>
  ...
  const stepTitles = ['Personal Information', 'Business & Location'];
    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-amber-50 to-stone-100 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-stone-500 text-sm mt-2">Ghana&apos;s Premium Wood Marketplace</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-stone-200 overflow-hidden">
          ...
          {/* Card Header */}
          <div className="bg-[#5a3e2b] px-8 py-5 text-white">
              ...
              <div className="space-y-4">
                ...
                <Field label="Country">
                  <select value={form.country} onChange={e => update('country', e.target.value)}
                    className="w-full border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all bg-white">
                ...
                <button onClick={handleNext}
                  className="w-full bg-[#5a3e2b] hover:bg-[#4a3220] text-white font-bold py-3.5 rounded-xl transition-all shadow-md text-sm mt-2">
                  Continue →
                </button>
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                <Field label="Region *">
                  <div className="relative">
                    <select value={form.region} onChange={e => update('region', e.target.value)}
                      className="w-full border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all bg-white appearance-none">
                ...
                <Field label="Business / Home Address">
                  <textarea value={form.address} onChange={e => update('address', e.target.value)}
                    className="w-full border border-stone-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all resize-none"
                ...
                {form.role !== 'buyer' && (
                  <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
                    ...
                    <p className="text-xs">After registration, upload your TIDD license and documents in the dashboard.</p>
                  </div>
                )}
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <button onClick={handleSubmit} disabled={loading}
                    className="flex-1 bg-[#5a3e2b] hover:bg-[#4a3220] disabled:opacity-60 text-white font-bold py-3 rounded-xl text-sm transition-all shadow-md">
                    {loading ? (
